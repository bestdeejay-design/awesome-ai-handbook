...
> Курируемый список русскоязычных AI-ресурсов: каналы, чаты, статьи и подкасты.
...
## Локальные ресурсы (этот handbook)

Большая часть **Awesome AI Handbook** написана на русском языке и покрывает темы, которых нет в русскоязычном сегменте:
...
| [agents/tutorials/](../agents/tutorials/) | Туториалы с кодом на русском |
...
2. Добавьте строку в соответствующий раздел
...
**Навигация:** [← Ресурсы](README.ru.md) · [↑ На главную](../README.ru.md) · [🇬🇧 English](ru.md)
