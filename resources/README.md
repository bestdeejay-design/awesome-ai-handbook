...
## Special Focus: RU Resources

There are virtually no curated lists of AI resources in Russian on GitHub. The [ru.md](ru.md) section is a **blue ocean** we're filling together.

Add a resource: [CONTRIBUTING.md](../CONTRIBUTING.md).
