...
Structured output — см. [agents/ollama-for-agents.ru.md](../agents/ollama-for-agents.ru.md#1-structured-output-json-schema).
...
- [agents/frameworks.md](../agents/frameworks.ru.md)
- [agents/patterns.md](../agents/patterns.ru.md)

---

## Связанные материалы

- [use-cases/rag.md](rag.ru.md) — документы и базы знаний
- [local-models/running-models.md](../local-models/running-models.ru.md) — настройка Ollama
