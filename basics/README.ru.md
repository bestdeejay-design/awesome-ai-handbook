...
| Шаг | Что делать |
|-----|-----------|
| 1 | [Что такое AI и зачем это нужно](what-is-ai.ru.md) |
| 2 | Установите **LM Studio** ([lmstudio.ai](https://lmstudio.ai)) — программа с кнопками |
...
| Шаг | Куда идти | Время |
|-----|-----------|-------|
| 1 | [Что такое AI?](what-is-ai.ru.md) | 5 мин |
| 2 | [Как работают нейросети?](how-models-work.ru.md) | 10 мин |
| 3 | [Облако или локально?](cloud-vs-local.ru.md) | 5 мин |
...
| 7 | [Какую модель выбрать](../local-models/models.ru.md) | 10 мин |
| 8 | [Кодинг с AI](../use-cases/coding.ru.md) | 20 мин |
| 9 | [Создать агента](../agents/tutorials/01-first-agent.ru.md) | 30 мин |
| 10 | [Память и контекст](../local-models/memory-and-context.ru.md) · [Квантизация](../local-models/quantization.ru.md) | 15 мин |
...
| Файл | О чём | Время |
|------|-------|-------|
| [what-is-ai.ru.md](what-is-ai.ru.md) | AI, ML, LLM — что это вообще такое | 5 мин |
| [how-models-work.ru.md](how-models-work.ru.md) | Как работает нейросеть (аналогиями, без формул) | 10 мин |
| [cloud-vs-local.ru.md](cloud-vs-local.ru.md) | ChatGPT vs локальная модель — что и когда выбирать | 5 мин |
| [hardware-guide.ru.md](hardware-guide.ru.md) | Какое нужно железо — от 8 GB RAM до сервера | 5 мин |
| [setup-windows.ru.md](setup-windows.ru.md) | Установка Ollama на Windows (нативный / WSL2) | 10 мин |
| [setup-linux.ru.md](setup-linux.ru.md) | Установка Ollama на Linux (CPU / CUDA / Docker) | 10 мин |
| [glossary.ru.md](glossary.ru.md) | Словарь терминов (35+ понятий) | ∞ |
| [faq.ru.md](faq.ru.md) | Частые вопросы новичков | 5 мин |
| [learning-path.ru.md](learning-path.ru.md) | Пошаговый план: от чата до своего агента | 10 мин |
