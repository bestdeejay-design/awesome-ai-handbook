...
| Step | What To Do |
|------|-----------|
| 1 | [What is AI and why it matters](what-is-ai.md) |
| 2 | Install **LM Studio** ([lmstudio.ai](https://lmstudio.ai)) — a GUI app with buttons |
...
|-----|-----------|-------|
| 1 | [What is AI?](what-is-ai.md) | 5 min |
| 2 | [How do neural networks work?](how-models-work.md) | 10 min |
| 3 | [Cloud or local?](cloud-vs-local.md) | 5 min |
...
| 7 | [Which model to choose](../local-models/models.md) | 10 min |
| 8 | [Coding with AI](../use-cases/coding.md) | 20 min |
| 9 | [Build an agent](../agents/tutorials/01-first-agent.md) | 30 min |
| 10 | [Memory and context](../local-models/memory-and-context.md) · [Quantization](../local-models/quantization.md) | 15 min |
...
| File | About | Time |
|------|-------|------|
| [what-is-ai.md](what-is-ai.md) | AI, ML, LLM — without math | 5 min |
| [how-models-work.md](how-models-work.md) | Neural networks explained by analogy | 10 min |
| [cloud-vs-local.md](cloud-vs-local.md) | ChatGPT vs local — what to choose | 5 min |
| [hardware-guide.md](hardware-guide.md) | Hardware requirements: 8 GB RAM to server | 5 min |
| [setup-windows.md](setup-windows.md) | Installing Ollama on Windows (native / WSL2) | 10 min |
| [setup-linux.md](setup-linux.md) | Installing Ollama on Linux (CPU / CUDA / Docker) | 10 min |
| [glossary.md](glossary.md) | Glossary of 35+ terms | ∞ |
| [faq.md](faq.md) | 15+ common beginner questions | 5 min |
| [learning-path.md](learning-path.md) | 10-step plan: chat → agent | 10 min |
