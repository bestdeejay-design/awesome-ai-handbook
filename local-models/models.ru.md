# <img src="https://lucide.dev/api/icons/target" alt="" width="20" height="20" style="vertical-align:middle"> Модели для разных задач
...
1. [Быстрый выбор по задачам](#1-быстрый-выбор-по-задачам)
2. [По объёму RAM](#2-по-объёму-ram)
3. [Ключевые возможности моделей](#3-ключевые-возможности-моделей)
4. [Модели для программирования](#4-модели-для-программирования)
5. [Чат-модели](#5-чат-модели)
6. [Модели для рассуждений](#6-модели-для-рассуждений)
7. [Модели для 8 GB](#7-модели-для-8-gb)
...
<table>
<thead>
<tr><th>Тип</th><th>Бит/вес</th><th>Качество</th><th>Размер</th><th>Когда использовать</th></tr>
</thead>
<tbody>
<tr><td>Q2_K</td><td>~2</td><td>Очень низкое</td><td>Очень маленькое</td><td>Только при критической нехватке памяти</td></tr>
<tr><td>Q3_K_S/M</td><td>~3-3.5</td><td>Низкое-среднее</td><td>Маленькое</td><td>Ограниченные ресурсы</td></tr>
<tr><td>Q4_0</td><td>4.0</td><td>Удовлетворительное</td><td>Среднее</td><td>Когда нужна предсказуемость</td></tr>
<tr><td>Q4_K_S/M</td><td>~4.3-4.8</td><td>Хорошее-отличное</td><td>Среднее</td><td>Баланс качества и размера</td></tr>
<tr><td>Q5_0</td><td>5.0</td><td>Очень хорошее</td><td>Больше среднего</td><td>Когда есть немного лишней памяти</td></tr>
<tr><td>Q5_K_S/M</td><td>~5.3-5.5</td><td>Отличное</td><td>Больше среднего</td><td>Высокое качество при умеренном размере</td></tr>
<tr><td>Q6_K</td><td>~6.0</td><td>Высокое</td><td>Большое</td><td>Для кода и критических задач</td></tr>
<tr><td>Q8_0</td><td>8.0</td><td>Почти как FP16</td><td>Большое</td><td>Когда памяти достаточно и нужно максимум качества</td></tr>
<tr><td>F16</td><td>16.0</td><td>Максимум</td><td>Очень большое</td><td>Для экспериментов и сравнения baseline</td></tr>
</tbody>
</table>

> <img src="https://lucide.dev/api/icons/lightbulb" alt="" width="20" height="20" style="vertical-align:middle"> **Совет по выбору квантизации**: Для большинства задач начните с **Q4_K_M** - это обычно лучший баланс качества, размера и скорости. Если нужно больше качества и есть память - переходите на Q5_K_M или Q6_K. Если критична скорость или очень мало памяти - рассмотрите Q3_K_M или Q2_K.
