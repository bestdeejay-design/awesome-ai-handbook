...
Полное сравнение инструментов — в [tools.md](tools.ru.md).
...
|-------------|-----------|
| **Понять, какую модель выбрать** для своих задач | [models.md](models.ru.md) |
| **Настроить производительность** под своё железо | [memory-and-context.md](memory-and-context.ru.md) |
