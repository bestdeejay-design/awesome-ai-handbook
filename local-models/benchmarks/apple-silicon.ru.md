...
|-------------|-----------|
| **Выбрать модель** под свой Mac | [models.md](../models.md) |
| **Сравнить инструменты** для максимальной скорости | [tools.md](../tools.md) |
| **Понять, сколько памяти нужно** | [memory-and-context.md](../memory-and-context.md) |
| **Вернуться к навигации** | [README.md](../README.md) |
