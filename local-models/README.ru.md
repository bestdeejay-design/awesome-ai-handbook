...
**Затем установка:** [📖 Подготовка окружения и установка](getting-started.ru.md) — Homebrew, Ollama, первая модель за 10 минут.
...
- [🤖 AI-агенты](../agents/README.ru.md) — агенты на локальных моделях
- [💼 Use Cases](../use-cases/README.ru.md) — кодинг, RAG, автоматизация
