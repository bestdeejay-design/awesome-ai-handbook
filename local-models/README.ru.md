...
- [x] **Детализация:** пошаговые инструкции в getting-started.md
- [x] **Детализация:** примеры API и Modelfile в advanced-setup.md
- [x] **Детализация:** проверка и уточнение всех cross-reference ссылок
- [x] Английская версия: перевод всех файлов раздела
