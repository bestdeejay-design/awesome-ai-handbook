...
Подробнее о TurboQuant и форматах — в [quantization.md](quantization.md).
...
Полный каталог с альтернативами — в [catalog.md](catalog.md). Рекомендации по задачам — в [models.md](models.md).
