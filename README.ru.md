...
**Что здесь есть (49 файлов, ~6 часов чтения):**
...
| [🤖 AI-агенты](#-ai-агенты--построить-своего-помощника) | 13 | 🟢→🔴 | ~2.5 ч |
...
**Где:** `agents/` · **Время:** ~2.5 ч · **Результат:** создаю автономных AI-агентов от простого ReAct до мульти-агентной команды
