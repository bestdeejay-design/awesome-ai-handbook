...
**Что здесь есть (52 файла, ~6 часов чтения):**
...
| [🤖 AI-агенты](#-ai-агенты--построить-своего-помощника) | 16 | 🟢→🔴 | ~3 ч |
...
| [orchestrators](agents/orchestrators.ru.md) | 🔵 Оркестраторы с субагентами: Atlas, Prometheus, установка | 🔵 |
