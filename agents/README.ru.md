...
| Документ | Описание |
|----------|----------|
| [patterns.md](patterns.ru.md) | ReAct, Plan-and-Execute, Multi-Agent, Reflection |
| [frameworks.md](frameworks.ru.md) | LangGraph, CrewAI, AutoGen, Agno, Mastra… |
| [ollama-for-agents.md](ollama-for-agents.ru.md) | Tool calling, JSON schema, OpenAI API |
...
4. use-cases/coding.ru.md  — пример для разработки
```
...
См. [ollama-for-agents.md](ollama-for-agents.ru.md).
