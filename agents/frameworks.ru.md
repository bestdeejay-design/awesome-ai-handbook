...
| **Локальная модель через Ollama** | Любой + [ollama-for-agents.md](ollama-for-agents.ru.md) |
...
Примеры API — в [ollama-for-agents.md](ollama-for-agents.ru.md).
...
| Подключить Ollama к вашему фреймворку | [ollama-for-agents.md](ollama-for-agents.ru.md) |
| Посмотреть пример кодинга с AI | [../use-cases/coding.ru.md](../use-cases/coding.ru.md) |
